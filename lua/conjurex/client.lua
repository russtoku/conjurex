-- [nfnl] Compiled from fnl/conjurex/client.fnl by https://github.com/Olical/nfnl, do not edit.
...
return {call = call, current = current, ["current-client-module-name"] = current_client_module_name, ["each-loaded-client"] = each_loaded_client, get = get, ["multiple-states?"] = multiple_states_3f, ["new-state"] = new_state, ["optional-call"] = optional_call, schedule = schedule, ["schedule-wrap"] = schedule_wrap, ["set-state-key!"] = set_state_key_21, ["state-key"] = state_key, version = version, ["with-filetype"] = with_filetype, wrap = wrap}
