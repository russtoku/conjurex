-- [nfnl] Compiled from fnl/conjurex/client/sql/stdio.fnl by https://github.com/Olical/nfnl, do not edit.
...
return {["->list"] = __3elist, ["buf-suffix"] = buf_suffix, ["comment-node?"] = comment_node_3f, ["comment-prefix"] = comment_prefix, ["eval-file"] = eval_file, ["eval-str"] = eval_str, ["form-node?"] = form_node_3f, interrupt = interrupt, ["on-exit"] = on_exit, ["on-filetype"] = on_filetype, ["on-load"] = on_load, start = start, stop = stop}
